...
#!/bin/bash
export WANDB_EXP=/nfs/nfs1/users/derekguo/vptr/experiment_output/wandb/$proj_name/
export EXP=/nfs/nfs1/users/derekguo/vptr/experiment_output/
export DATA=gs://bridge_v2_chet/bridge_data_all_numpy_lang_224
...
# --pretrained_encoder /nfs/nfs1/users/chet/jaxrl2_private/pretrained_encoders_new/icvf224_0 \
