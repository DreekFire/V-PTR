...
class WandBLogger(object):
    def __init__(self, wandb_logging, variant, project, experiment_id,  output_dir=None, group_name='', team='derekguo'):
        self.wandb_logging = wandb_logging
        # if "gs://" in output_dir:
        #     output_dir = tf.io.gfile.join(output_dir, experiment_id)
        # else:
        ...
        if wandb_logging:
            ...
            from vptr.utils.wandb_config import get_wandb_config
