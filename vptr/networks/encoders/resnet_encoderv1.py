...
from vptr.networks.mlp import default_init, xavier_init, kaiming_init
from vptr.networks.encoders.spatial_softmax import SpatialSoftmax, SpatialLearnedEmbeddings
from vptr.networks.encoders.cross_norm import CrossNorm
